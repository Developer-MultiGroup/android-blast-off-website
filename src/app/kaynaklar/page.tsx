    ...
    <div className="min-h-screen flex flex-col">
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-8 w-full font-montserrat-mid">
            <motion.div
            ...
            >
              ...
              <Input
                ...
                className="pl-10 bg-gray-800/70 border border-gray-600/30 text-gray-300 placeholder:text-gray-300 focus-visible:ring-accent w-full"
                value={searchQuery}
            ...
            <div className="flex flex-col sm:flex-row w-full md:w-auto gap-2">
              ...
              >
                <select
                  ...
                  className="w-full pl-3 pr-10 py-2 bg-gray-800/70 border border-gray-600/30 text-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-accent"
                >
              ...
              >
                <select
                  ...
                  className="w-full pl-3 pr-10 py-2 bg-accent border border-gray-600/30 text-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-accent"
                >
